...
private:
    static void PrintTransferLogRecordLine(clsBankClient::stTransferLogRecord TransferLogRecord)
    {
        ...
        cout << "| " << setw(8) << left << TransferLogRecord.desAccountNumber;
        cout << "| " << setw(8) << left << TransferLogRecord.Amount;
        cout << "| " << setw(10) << left << TransferLogRecord.srcAccountBalance;
        cout << "| " << setw(10) << left << TransferLogRecord.desAccountBalance;
...
public:
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsBankClient::stTransferLogRecord> vTransferLogRecord = clsBankClient::_LoadTransfersDataFromFile();
